...
object SlickBuild extends Build {
  ...
  val slickVersion = "2.1.0-skozlov1"
  val binaryCompatSlickVersion = "2.1.0-skozlov1" // Slick base version for binary compatibility checks
  val scalaVersions = Seq("2.10.4", "2.11.8")
